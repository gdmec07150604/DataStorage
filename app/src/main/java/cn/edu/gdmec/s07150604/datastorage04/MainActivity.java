package cn.edu.gdmec.s07150604.datastorage04;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void spWrite(View v){
        ...
        editor.commit();
        Toast.makeText(this,"SharedPerences写入成功",Toast.LENGTH_LONG).show();
    }
    public void spRead(View v){
       ...
       String acount =user.getString("account","木有这个键值");
        ...
        Toast.makeText(this,"SharedPerences读取成功",Toast.LENGTH_LONG).show();
    }
